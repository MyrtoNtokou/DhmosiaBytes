...
public final class Barcharts {
    ...
    /**
    * Enum representing income categories steliou.
    */
    public enum IncomeOptions {
        ...
        /**
        * Returns the income code.
        * @return code of the income.
        */
        ...
        * @return description of the income.
        */
    ...
    /**
    * Creates a bar chart for the selected income category per year.
    *
    * @param x index of the income category (1-based).
    */

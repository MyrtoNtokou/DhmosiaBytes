...
class TestInvestmentAnalyzer {
    ...
    void setUp() {
        ...
        ministries.add(new Ministry(24, "Ministry C", new BigDecimal("0"), new BigDecimal("0"), new BigDecimal("0"))); // total=0

        // Ministries outside code range (should be ignored)
        ministries.add(new Ministry(3, "Ministry D", new BigDecimal("500"), new BigDecimal("500"), new BigDecimal("1000")));
        ministries.add(new Ministry(25, "Ministry E", new BigDecimal("500"), new BigDecimal("500"), new BigDecimal("1000")));
    }
    ...
    void testCalculateRatios() {
        ...
        assertEquals("Ministry B", first.getName());
        ...
        assertEquals("Ministry A", second.getName());
        ...
        assertEquals("Ministry C", third.getName());
    ...
    void testMinistriesOutsideRangeIgnored() {
        ...
        assertTrue(results.stream().noneMatch(r -> r.getName().equals("Ministry D")));
        assertTrue(results.stream().noneMatch(r -> r.getName().equals("Ministry E")));
    }
}
